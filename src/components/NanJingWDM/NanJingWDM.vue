<template>
    <div class="mainpage">
      ...
      <introduce :proContent="wdmContent"></introduce>
      ...
      <el-button type="danger"><a style="color: #fff" href="tel:15251885168">致电售楼处预约</a></el-button>
    ...
    export default{
        ...
        methods: {
            addSubscribe(){
              ...
              subscribeApi.addSubscribe(this.phone,this.name,'wdm').then((response) =>{
                console.log(222)
                alert("预约成功！")
                that.phone = "";
                that.name = ""
