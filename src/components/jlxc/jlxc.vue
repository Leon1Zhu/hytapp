<template>
  <div class="mainpage jlxc">
    <div class="titleInfo font-size-top">九龙兴城</div>
    <swiper class="swiperImgConter" :options="swiperOption" ref="mySwiper">
      <!-- slides -->
      <swiper-slide><img class="swiperImg" src="../../assets/jlxc/jlxc1.jpeg"></swiper-slide>
      <swiper-slide><img class="swiperImg" src="../../assets/jlxc/jlxc2.jpeg"></swiper-slide>
      <swiper-slide><img class="swiperImg" src="../../assets/jlxc/jlxc3.jpeg"></swiper-slide>
      <!-- Optional controls -->
  ...
  export default{
    ...
    methods: {
      addSubscribe(){
        ...
        subscribeApi.addSubscribe(this.phone,this.name,'JLXC').then((response) =>{
          alert("预约成功！")
          that.phone = "";
          that.name = ""
